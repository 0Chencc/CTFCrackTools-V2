...
class Core {
    ...
    fun CryptoWindow() {//主窗口
        ...
        val BaconCodeDecode=JMenuItem(rb.getString("MenuCodeBaconDecode"))
        val BaconCodeEncode=JMenuItem(rb.getString("MenuCodeBaconEncode"))
        ...
        val VigenereEncode = JMenuItem(rb.getString("MenuCodeVigenereEncode"))
        val VigenereDecode = JMenuItem(rb.getString("MenuCodeVigenereDecode"))
        //
        ...
        Ascii.add(VigenereEncode)
        Ascii.add(VigenereDecode)
        ...
        BaconCodeDecode.addActionListener{ output.text=f.BaconCodeDecode(input.text) }
        BaconCodeEncode.addActionListener{ output.text=f.BaconCodeEncode(input.text) }
        zj.addActionListener{output.text=f.PigCode(input.text)}
        rot13.addActionListener{output.text=f.Rot13(input.text)}
        fence.addActionListener{output.text=f.Fence(input.text)}
        ...
        morsed.addActionListener{ output.text=f.MorseDecode(input.text) }
        reverse.addActionListener{output.text=f.reverse(input.text) }
        UrlCodee.addActionListener{output.text=f.UrlEncoder(input.text) }
        UrlCoded.addActionListener{output.text=f.URLDecoder(input.text) }
        ...
        VigenereEncode.addActionListener{output.text=f.VigenereEnCode(output.text.toCharArray(),JOptionPane.showInputDialog("Please input a key").toCharArray())}
        VigenereDecode.addActionListener{output.text=f.VigenereDeCode(output.text.toCharArray(),JOptionPane.showInputDialog("Please input a key").toCharArray())}
    ...
    private fun buildPluginMenu(menu: JMenu) {
        //
        if(File(JsonPath).isFile() && File(JsonPath).exists() && json.isJSON(JsonPath)) {
